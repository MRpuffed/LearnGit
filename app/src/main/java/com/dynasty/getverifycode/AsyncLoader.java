...
/**
 * Created by Dynasty_Qin on 2017/5/5.
 */
/**
 * AsyncTask类的三个泛型参数：
...
public class AsyncLoader extends AsyncTask<String, Integer, String> {
    ...
    public AsyncLoader(TextView v) {
        tv = v;
    }
    @Override
    protected void onPreExecute() {
        Log.w("Dynasty_Qin", "task onPreExecute()");
    }
    ...
    protected java.lang.String doInBackground(java.lang.String... params) {
        Log.w("Dynasty_Qin", "task doInBackground()");
    ...
    protected void onPostExecute(java.lang.String s) {
        Log.w("Dynasty_Qin", "task onPostExecute()");
        tv.setText(s);
    }
